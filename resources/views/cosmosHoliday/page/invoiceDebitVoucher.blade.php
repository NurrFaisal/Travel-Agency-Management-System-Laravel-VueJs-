    ...
    <section class="invoice" style="margin: 10px -15px; border: 0">
        ...
        <div class="invoice-info">
            ...
            <div class="row">
                ...
                <p style="text-align: center">Plaza A.R, Dhanmondi 27, Dhaka, Bangladesh.</p>
            </div>
            <div class="row">
                <h4 style="text-align: center">Debit Voucher</h4>
            </div>
            <div class="row">
                <div>
                    <font size="2" face="Courier New" >
                        <div class="row" style="margin: 0px 5px">
                            ...
                            <div class="col-xs-4 col-md-4" style="float: left">Debit Voucher Number : DV-{{$debit_voucher->id}}</div>
                            <div class="col-xs-4 col-md-4" style="text-align: right; float: right" >Date : {{$debit_voucher->created_at->format('d-m-Y')}}</div>
                        </div>
                    </font>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 table-responsive">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                        <tr >
                            <td colspan="4" height="5"   style="padding: 4px">Name : {{$debit_voucher->supliert->name}}</td>
                        </tr>
