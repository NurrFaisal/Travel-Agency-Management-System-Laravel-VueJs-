                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Create New Suplier</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addSuplier()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addSuplier() {
                this.isLoading = true
                this.form.post('/api/add-suplier')
                    .then((response) => {
                        this.doAjax()
                        this.form.name = ''
                        ...
                        Toast.fire({
                            type: 'success',
                            title: ' New Suplier Added successfully'
                        })
                    })
            }
        }
