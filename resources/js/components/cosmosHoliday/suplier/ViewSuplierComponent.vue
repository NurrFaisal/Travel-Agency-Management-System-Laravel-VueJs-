        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Suplier Transaction</li>
                </ul><!-- /.breadcrumb -->
                                                        ...
                                                        <div class="col-xs-12">
                                                            <table id="simple-table_transaction" class="table  table-bordered table-hover">
                                                                ...
                                                                <tr v-for="(transjaction, index) in  transjactions">
                                                                    <td>{{transjaction.transaction_date | timeformate}}</td>
                                                                    ...
                                                                    <td>{{transjaction.suplier_balance}}</td>
    ...
    export default {
        ...
        methods:{
            ...
            getAllGuestTransaction(){
                axios.get(`/api/get-all-suplier-transaction/${this.$route.params.id}?page=`+this.pagination.current_page)
                    .then(response => {
                        this.transjactions = response.data.transjaction.data
                        this.pagination = response.data.transjaction
            ...
            getAllSearchTransaction(searchText){
                axios.get(`/api/get-all-suplier-transaction-search/${this.$route.params.id}/`+searchText+'?page='+this.pagination.current_page)
                    .then(response => {
                        this.transjactions = response.data.transjaction.data
                        this.pagination = response.data.transjaction
                        this.isLoading = false
