                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Update Checked By Asst Visa Information</h5>
...
<script>
    ...
    export default {
        name: "EditCheckedByAsstVisaUpdated",
        ...
        methods:{
            ...
            updateVisaUpdated(){
                this.isLoading = true
                this.form.post('/api/update-visa-updated-checked-by-asst')
                    .then((response) => {
                        this.form.id=''
                        this.form.passports = [
                            {
