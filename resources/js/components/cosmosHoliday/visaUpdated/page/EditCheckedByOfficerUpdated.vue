                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Update Checked By Officer Visa Information</h5>
...
<script>
    ...
    export default {
        name: "EditCheckedByOfficerUpdated",
        ...
        methods:{
            ...
            updateVisaUpdated(){
                this.isLoading =true
                this.form.post('/api/update-visa-updated-checked-by-officer')
                    .then((response) => {
                        this.form.id=''
                        this.form.passports = [
                            {
