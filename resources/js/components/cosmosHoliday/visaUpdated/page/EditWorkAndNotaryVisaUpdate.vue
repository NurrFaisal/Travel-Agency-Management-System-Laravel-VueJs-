                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Update Work and Notary Visa Information</h5>
...
<script>
    ...
    export default {
        name: "EditWorkAndNotaryVisaUpdate",
        ...
        methods:{
            ...
            updateVisaUpdated(){
                this.isLoading = true
                this.form.post('/api/update-visa-updated-work-and-notary')
                    .then((response) => {
                        this.form.id=''
                        this.form.passports = [
                            {
