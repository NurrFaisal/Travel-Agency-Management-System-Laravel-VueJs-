                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Update Delivered Visa Information</h5>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            ...
                                                            <span class="block input-icon input-icon-right">
                                                                <select v-validate="'required'" :class="{ 'is-invalid': form.errors.has('collected_by') }" required v-model="form.collected_by" id="collected_by" name="collected_by" class="col-xs-12 col-sm-12" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            <label for="call_and_sms_date">
                                                                GCS Date <span class="text-danger">*</span> :
                                                            </label>
                                                            <span class="block input-icon input-icon-right">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            <label for="call_and_sms_by">
                                                                GCS by <span class="text-danger">*</span> :
                                                            </label>
                                                            <span class="block input-icon input-icon-right">
                                                                <select v-validate="'required'" :class="{ 'is-invalid': form.errors.has('call_and_sms_by') }" required v-model="form.call_and_sms_by" id="call_and_sms_by" name="call_and_sms_by" class="col-xs-12 col-sm-12" >
                                                                    <option value="">--Select GCS By--</option>
                                                                    <option  :value="staff.id" v-for="staff in getAllStaff " >{{staff.first_name+' '+ staff.last_name}}</option>
                                                                </select>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            <label for="delevered_by">
                                                                Delivery by <span class="text-danger">*</span> :
                                                            </label>
                                                            <span class="block input-icon input-icon-right">
                                                                <select v-validate="'required'" :class="{ 'is-invalid': form.errors.has('delevered_by') }" required v-model="form.delevered_by" id="delevered_by" name="delevered_by" class="col-xs-12 col-sm-12" >
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            updateVisaUpdated(){
                this.isLoading =true
                this.form.post('/api/update-visa-updated-delevered-by')
                    .then((response) => {
                        this.form.id=''
                        this.form.passports = [
                            {
