<template>
    <div class="autocomplate" >
        <div class="input" @click="toggleVisible" ><span class="spanText" v-text="selectedItem ? selectedItem['name']+' '+ selectedItem[filterby] : ''"></span></div>
            ...
            <div class="options" ref="optionList">
                <ul>
                    <li
                            ...
                            v-text="match['name']+' - '+match['phone_number']"
