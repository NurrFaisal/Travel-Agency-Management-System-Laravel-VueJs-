                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Customer</h5>
                                        ...
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="updateGuest()" class="form-horizontal" method="post" role="form">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input v-validate="'required'" v-model="form.id" :class="{ 'is-invalid': form.errors.has('name') }"   class="col-xs-12 col-sm-8" id="id" name="id" placeholder="Enter Guest Name" required="" type="hidden">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                            <AutoComplate :shouldReset="true" @change="onchange" :items="staffs" filterby="first_name" :title="this.first_name+' '+this.last_name"  @Selected="customerSelected"/>
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                            <div class="row">
                                                                <div class="radio col-md-4">
                                                                    <label>
                                                                        <input  v-model="form.type" class="ace input-sm" name="type" type="radio" value="0">
        ...
        mounted(){
            ...
            axios.get(`/api/edit-guest/${this.$route.params.id}`)
                .then((respose) => {
                    ...
                    this.first_name = respose.data.guest.staff.first_name;
                    this.last_name = respose.data.guest.staff.last_name;
                })
        },
        computed:{
            getAllGuestTitle(){
