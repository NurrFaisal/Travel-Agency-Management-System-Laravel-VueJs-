                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Add Guest Confirmation</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addGuestConfirmation()" class="form-horizontal" method="post" role="form">
    ...
    export default {
        ...
        methods:{
            addGuestConfirmation(){
                this.isLoading = true
                this.form.post('/api/add-guest-confirm')
                    .then((response) => {
                        this.$session.start()
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Guest Confirmation Added successfully'
                        })
                    })
                    .catch((response) => {
                        this.isLoading = false
