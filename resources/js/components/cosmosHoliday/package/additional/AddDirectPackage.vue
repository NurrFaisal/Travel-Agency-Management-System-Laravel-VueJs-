                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">New Quick Package</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addQuickPackage()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods:{
            addQuickPackage(){
                this.form.post('/api/add-direct-package')
                    .then((response) => {
                        this.$session.start()
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'New Quick Package Added successfully'
                        })
