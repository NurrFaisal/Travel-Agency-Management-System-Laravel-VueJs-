                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit VISA Update</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updatePackageVisaUpdate()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditVisaPackageUpdate",
        components: {GuestAutoComplate, Loading},
        mounted(){
            this.isLoading = true
            this.$store.dispatch("allAirTicketStaff")
            axios.get(`/api/edit-package-visa-update/${this.$route.params.id}`)
                .then((respose) => {
                    this.form.fill(respose.data.update_visa)
                    this.name = respose.data.update_visa.guestt.name;
                    this.phone_number = respose.data.update_visa.guestt.phone_number;
        ...
        methods:{
            updatePackageVisaUpdate(){
                this.form.post('/api/update-package-visa-update')
                    .then((response) => {
                        this.$session.start()
