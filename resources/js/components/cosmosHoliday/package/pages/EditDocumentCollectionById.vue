        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit Package Document Collection</li>
                </ul><!-- /.breadcrumb -->
                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Package Document Collection</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="updateDocumentCollectionByGuest()" class="form-horizontal" method="post" role="form">
...
<!--                                                        <input type="number" v-validate="'required'" v-model="form.note" placeholder="Enter Number Of Infant" :class="{ 'is-invalid': form.errors.has('note') }"   class="col-xs-12 col-sm-8" id="infant" name="infant"  required="">-->
                                                ...
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="visa_update_date">
                                                        Visa Update Date<span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="date" v-validate="'required'" v-model="form.visa_update_date" :class="{ 'is-invalid': form.errors.has('visa_update_date') }"   class="col-xs-12 col-sm-8" id="visa_update_date" name="visa_update_date"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="visa_update_date"></has-error>
                                                        <span style="color: red">{{ errors.first('visa_update_date') }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="visa_update_note">
                                                        Visa Updated Note <span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="text" v-validate="'required'" v-model="form.visa_update_note" :class="{ 'is-invalid': form.errors.has('visa_update_note') }"   class="col-xs-12 col-sm-8" id="visa_update_note" name="visa_update_note"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="visa_update_note"></has-error>
                                                        <span style="color: red">{{ errors.first('visa_update_note') }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="ready_for_delivery">
                                                        Ready For Delivery <span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="date" v-validate="'required'" v-model="form.ready_for_delivery" :class="{ 'is-invalid': form.errors.has('ready_for_delivery') }"   class="col-xs-12 col-sm-8" id="ready_for_delivery" name="ready_for_delivery"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="ready_for_delivery"></has-error>
                                                        <span style="color: red">{{ errors.first('ready_for_delivery') }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="ready_for_delivery_note">
                                                        Ready For Delivery Note<span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="text" v-validate="'required'" v-model="form.ready_for_delivery_note" :class="{ 'is-invalid': form.errors.has('ready_for_delivery_note') }"   class="col-xs-12 col-sm-8" id="ready_for_delivery_note" name="ready_for_delivery_note"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="ready_for_delivery_note"></has-error>
                                                        <span style="color: red">{{ errors.first('ready_for_delivery_note') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="payment_date">
                                                        Paymnet Date <span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="date" v-validate="'required'" v-model="form.payment_date" :class="{ 'is-invalid': form.errors.has('payment_date') }"   class="col-xs-12 col-sm-8" id="payment_date" name="payment_date"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="payment_date"></has-error>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="number" v-validate="'required'" v-model="form.net_price" :class="{ 'is-invalid': form.errors.has('net_price') }"   class="col-xs-12 col-sm-8" id="net_price" name="net_price"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="number" v-validate="'required'" v-model="form.price" :class="{ 'is-invalid': form.errors.has('price') }"   class="col-xs-12 col-sm-8" id="price" name="price"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="number" v-validate="'required'" v-model="form.advance" :class="{ 'is-invalid': form.errors.has('advance') }"   class="col-xs-12 col-sm-8" id="advance" name="advance"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                ...
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="payment_note">
                                                        Payment Note <span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="text" v-validate="'required'" v-model="form.payment_note" :class="{ 'is-invalid': form.errors.has('payment_note') }"   class="col-xs-12 col-sm-8" id="payment_note" name="payment_note"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="payment_note"></has-error>
                                                        <span style="color: red">{{ errors.first('payment_note') }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="document_collection_by_date">
                                                        Document Collection Date<span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="date" v-validate="'required'" v-model="form.document_collection_by_date" :class="{ 'is-invalid': form.errors.has('document_collection_by_date') }"   class="col-xs-12 col-sm-8" id="document_collection_by_date" name="document_collection_by_date"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="document_collection_by_date"></has-error>
                                                        <span style="color: red">{{ errors.first('document_collection_by_date') }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="col-xs-12 col-sm-2 col-md-2 control-label no-padding-right"
                                                           for="document_collection_by_note">
                                                        Document Collection Note <span class="text-danger">*</span> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-7">
                                                        <span class="block input-icon input-icon-right">
                                                        <input type="text" v-validate="'required'" v-model="form.document_collection_by_note" :class="{ 'is-invalid': form.errors.has('document_collection_by_note') }"   class="col-xs-12 col-sm-8" id="document_collection_by_note" name="document_collection_by_note"  required="">
                                                        </span>
                                                    </div>
                                                    <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        <has-error style="color:red" :form="form" field="document_collection_by_note"></has-error>
                                                        <span style="color: red">{{ errors.first('document_collection_by_note') }}</span>
                                                    </div>
                                                </div>
...
<script>
    export default {
        name: "EditDocumentCollectionById",
        mounted(){
            axios.get(`/api/edit-document-collection-by-guest/${this.$route.params.id}`)
                .then((respose) => {
                    this.form.fill(respose.data.dcbg)
        ...
        data(){
            return {
                ...
                form: new Form({
                    ...
                    visa_update_note: '',
                    ready_for_delivery: '',
                    ready_for_delivery_note: '',
                    payment_date: '',
                    net_price: '',
                    price: '',
                    advance: '',
                    payment_note: '',
                    document_collection_by_date: '',
                    document_collection_by_note: '',
                })
            }
        },
        methods:{
            updateDocumentCollectionByGuest(){
                this.form.post('/api/update-document-collection-by-guest')
                    .then((response) => {
                        this.$session.start()
                        ...
                        this.form.visa_update_date = ''
                        this.form.visa_update_note = ''
                        this.form.ready_for_delivery = ''
                        this.form.ready_for_delivery_note = ''
                        this.form.payment_date = ''
                        this.form.net_price = ''
                        this.form.price = ''
                        this.form.advance = ''
                        this.form.payment_note = ''
                        this.form.document_collection_by_date = ''
                        this.form.document_collection_by_note = ''
                        this.$router.push('/package-list')
                        Toast.fire({
                            type: 'success',
                            title: 'Document Collection Updated Successfully'
                        })
