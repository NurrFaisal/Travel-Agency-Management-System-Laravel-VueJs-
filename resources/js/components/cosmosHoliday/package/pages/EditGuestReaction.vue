                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Follow up To Guest</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateGuestReaction()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditGuestReaction",
        components: {GuestAutoComplate, Loading},
        mounted(){
            this.isLoading = true
            this.$store.dispatch("allAirTicketStaff")
            axios.get(`/api/edit-guest-reaction/${this.$route.params.id}`)
                .then((respose) => {
                    this.form.fill(respose.data.edit_guest_reaction)
                    this.name = respose.data.edit_guest_reaction.guestt.name;
                    this.phone_number = respose.data.edit_guest_reaction.guestt.phone_number;
        ...
        methods:{
            updateGuestReaction(){
                this.form.post('/api/update-guest-reaction')
                    .then((response) => {
                        this.$session.start()
