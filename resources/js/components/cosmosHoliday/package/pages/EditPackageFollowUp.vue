                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Package Follow Up To Guest</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updatePackageFollowUp()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditPackageFollowUp",
        components: {GuestAutoComplate, Loading},
        mounted(){
            this.isLoading = true
            this.$store.dispatch("allAirTicketStaff")
            axios.get(`/api/edit-package-follow-up/${this.$route.params.id}`)
                .then((respose) => {
                    this.form.fill(respose.data.package_follow_up)
                    this.name = respose.data.package_follow_up.guestt.name;
                    this.phone_number = respose.data.package_follow_up.guestt.phone_number;
        ...
        methods:{
            updatePackageFollowUp(){
                this.form.post('/api/update-package-follow-up')
                    .then((response) => {
                        this.$session.start()
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Package Follow up Updated successfully'
                        })
