                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Delivered Document</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateDocumentDelivered()" class="form-horizontal" method="post" role="form">
...
<!--                                                                <input disabled  v-model="form.grand_total_price" :class="{ 'is-invalid': form.errors.has('grand_total_price') }"   class="col-xs-12 col-sm-12" id="grand_total_price" name="grand_total_price" placeholder="Grand Total Price" required="" type="number">-->
                                                ...
                                                <div v-for="(employee, index) in form.net_prices" style="background-color: #f6f6f6; padding: 15px; margin: 20px;padding-bottom: 55px; cursor: pointer;">
                                                    <div class="row">
                                                        <button v-if="index > 0"  @click.prevent="deleteNet(index)" class="float-right" style="float: right;background: #dff0d8;margin-top: -14px">X</button>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="col-xs-12 col-sm-12">
                                                                ...
                                                                <span class="block input-icon input-icon-right">
                                                                <input  @keyup="sumNetPrice()" v-validate="'required'" v-model="employee.amount" :class="{ 'is-invalid': form.errors.has('net_price') }"   class="col-xs-12 col-sm-12" id="net_price" name="net_price" placeholder="Enter Net Price"  required type="number">
                                                            </span>
                                                            </div>
                                                            <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            <label for="document_ready_date">
                                                                Document Ready Date<span class="text-danger">*</span> :
                                                            </label>
                                                            <span class="block input-icon input-icon-right">
                                                                <input v-validate="'required'" v-model="form.document_ready_date" :class="{ 'is-invalid': form.errors.has('document_ready_date') }"   class="col-xs-12 col-sm-12" id="document_ready_date" name="document_ready_date"  required="" type="date">
                                                            </span>
                                                        </div>
                                                        <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                            <has-error style="color:red" :form="form" field="document_ready_date"></has-error>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            <label for="document_delivery_date">
                                                                Document Delivery Date<span class="text-danger">*</span> :
                                                            </label>
                                                            <span class="block input-icon input-icon-right">
                                                                <input v-validate="'required'" v-model="form.document_delivery_date" :class="{ 'is-invalid': form.errors.has('document_delivery_date') }"   class="col-xs-12 col-sm-12" id="document_delivery_date" name="document_delivery_date"  required="" type="date">
                                                            </span>
                                                        </div>
                                                        <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                            <has-error style="color:red" :form="form" field="document_delivery_date"></has-error>
...
<script>
    ...
    export default {
        ...
        mounted(){
            axios.get(`/api/edit-date-of-journey/${this.$route.params.id}`)
                .then((respose) => {
                    ...
                    this.form.total_net_price = respose.data.doj.grand_total_net_price
                    this.name = respose.data.doj.guestt.name;
                    this.phone_number = respose.data.doj.guestt.phone_number;
        ...
        methods:{
            ...
            deleteNet(index){
                this.$delete(this.form.net_prices, index)
            },
            sumNetPrice(){
                this.form.total_net_price = 0
                for(let i = 0; i < this.form.net_prices.length; i++){
                    if(this.form.net_prices[i].amount != ''){
                        this.form.total_net_price += parseInt(this.form.net_prices[i].amount)
                    }
                }
            },
            ...
            updateDocumentDelivered(){
                this.form.post('/api/update-date-of-journey')
                    .then((response) => {
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Package Net Price Updated successfully'
                        })
