                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Document Ready</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateDocumentReady()" class="form-horizontal" method="post" role="form">
        ...
        mounted(){
            axios.get(`/api/edit-drfdp/${this.$route.params.id}`)
                .then((respose) => {
                    ...
                    this.form.total_net_price = respose.data.drfdp.grand_total_net_price
                    this.name = respose.data.drfdp.guestt.name;
                    this.phone_number = respose.data.drfdp.guestt.phone_number;
