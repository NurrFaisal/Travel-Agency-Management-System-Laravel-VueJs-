                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Tour Plan Submit To Guest</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateItineraryCostSubmitDate()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditItineraryCostSubmitDate",
        components: {GuestAutoComplate, Loading},
        mounted(){
            this.isLoading = true
            this.$store.dispatch("allAirTicketStaff")
            axios.get(`/api/edit-itinerary-cost-submit-date/${this.$route.params.id}`)
                .then((respose) => {
                    this.form.fill(respose.data.itinerary_cost_submit_date)
        ...
        methods:{
            updateItineraryCostSubmitDate(){
                this.form.post('/api/update-itinerary-cost-submit-date')
                    .then((response) => {
                        this.$session.start()
