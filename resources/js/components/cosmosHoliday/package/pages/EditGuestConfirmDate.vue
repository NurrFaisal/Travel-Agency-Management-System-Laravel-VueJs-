                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Guest Confirmation</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateGuestConfirmation()" class="form-horizontal" method="post" role="form">
    ...
    export default {
        ...
        mounted(){
            ...
            axios.get(`/api/edit-guest-confirmation/${this.$route.params.id}`)
                .then((respose) => {
                    ...
                    this.name = respose.data.guest_confirmation.guestt.name;
                    this.phone_number = respose.data.guest_confirmation.guestt.phone_number;
        ...
        methods:{
            updateGuestConfirmation(){
                this.form.post('/api/update-guest-confirmation')
                    .then((response) => {
                        this.$session.start()
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Guest Confirmation Updated successfully'
                        })
