        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <router-link to="/visa-list">Visa List</router-link>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="page-header">
                    <h1>
                        ...
                        <div class="card-tools" style="float:right">
                            <router-link class="btn btn-success" to="/new-visa">Add New Visa</router-link>
                        </div>
                        <br/>
                    </h1>
                </div><!-- /.page-header -->
                                            ...
                                            <div class="col-xs-12">
                                                <table id="simple-table" class="table  table-bordered table-hover">
                                                    ...
                                                    <tr v-for="(r_visa, index) in recieved_visas">
                                                        ...
                                                        <td class="center">{{r_visa.price - r_visa.net_price}}</td>
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                <a href="http://demo.iglweb.com/ta/user/visa-register/show/41" class="btn btn-xs btn-success">
                                                                    <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                </a>
                                                                <router-link  :to="`/edit-received-visa/${r_visa.id}`" class="btn btn-xs btn-info">
                                                    ...
                                                    <tr v-for="(work, index) in work_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-work-and-notary-visa/${work.id}`" class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <tr v-for="(c_asst, index ) in checked_by_asst_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-checked-by-asst-visa/${c_asst.id}`" class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <tr v-for="(c_officer, index) in checked_by_officer_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-checked-by-officer-visa/${c_officer.id}`"  class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <tr v-for="(s_visa, index) in submit_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-submited-visa/${s_visa.id}`"  class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <div class="modal-body">
                                                        <form @submit.prevent="addVisaCallAndSms()" method="post">
                                                            <div class="row">
                                                                <label for="collected_by" class="col-sm-5">Collected By:</label>
                                                                <div class="col-sm-7">
                                                                    <select v-model="form6.call_and_sms_by" class="form-control " id="collected_by" name="collected_by" required style="width: 95%;">
                                                                        <option value="">--Select Collected Person--</option>
                                                                        <option :value="work.id" v-for="work in getAllVisaStaff">{{work.first_name+' '+work.last_name}}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                                    <has-error style="color:red" :form="form6" field="collected_by"></has-error>
                                                                    <span style="color: red">{{ errors.first('collected_by') }}</span>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="row">
                                                                <label for="collected_date" class="col-sm-5">Collected Date:</label>
                                                                <div class="col-sm-7">
                                                                    <input type="date" v-model="form6.call_and_sms_date" id="collected_date" name="collected_date" class="form-control"  style="max-width: 95%;" value="" required="">
                                                                    <input type="hidden" v-model="form6.id" >
                                                                </div>
                                                                <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                                    <has-error style="color:red" :form="form6" field="collected_date"></has-error>
                                                                    <span style="color: red">{{ errors.first('collected_date') }}</span>
                                                                </div>
                                                            </div>
                                                            <br>
                                                    ...
                                                    <tr v-for="(collected,index) in collected_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link  :to="`/edit-collected-visa/${collected.id}`" class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <tr v-for="(gcs, index) in gcs_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-call-and-sms-visa/${gcs.id}`" class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
                                                    ...
                                                    <tr v-for="(d_visa,index) in delelvered_visas">
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group center">
                                                                ...
                                                                <router-link :to="`/edit-delivery-visa/${d_visa.id}`" class="btn btn-xs btn-info">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </router-link>
...
<script>
    import GuestCallSms_passport from "./include/GuestCallSms_passport";
    import Delevered_passport from "./include/Delevered_passport";

    export default {
        name: "ListVisaComponent",

        components: {
            Delevered_passport,
            GuestCallSms_passport,
        },
        ...
        methods: {
            ...
            getAllReceivedWithPagination(){
                axios.get('/api/get-all-recieved-visa?page='+this.r_pagination.current_page)
                    .then(response => {
            ...
            getAllWorkWithPagination(){
                axios.get('/api/get-all-work-visa?page='+this.w_pagination.current_page)
                    .then(response => {
            ...
            getAllCheckedByAsstWithPagination(){
                axios.get('/api/get-all-checked-by-asst-visa?page='+this.cba_pagination.current_page)
                    .then(response => {
            ...
            getAllCheckedByOfficerWithPagination(){
                axios.get('/api/get-all-checked-by-offcer-visa?page='+this.cbo_pagination.current_page)
                    .then(response => {
            ...
            getAllSubmitedWithPagination(){
                axios.get('/api/get-all-submit-visa?page='+this.s_pagination.current_page)
                    .then(response => {
            ...
            getAllCollectedWithPagination(){
                axios.get('/api/get-all-collected-visa?page='+this.c_pagination.current_page)
                    .then(response => {
            ...
            getAllGCSWithPagination(){
                axios.get('/api/get-all-gcs-visa?page='+this.g_pagination.current_page)
                    .then(response => {
            ...
            getAllDelevetedWithPagination(){
                axios.get('/api/get-all-delevered-visa?page='+this.d_pagination.current_page)
                    .then(response => {
            ...
            addVisaCheckedByAsst(){
                this.form2.post('/api/add-checked-asst-by')
                    .then((response) => {
                        this.form2.reset()
                        this.getAllWorkWithPagination();
                        this.getAllCheckedByAsstWithPagination();
            ...
            addVisaCheckedByOfficer(){
                this.form3.post('/api/add-checked-by-officer')
                    .then((response) => {
                        this.form3.reset()
                        this.getAllCheckedByAsstWithPagination();
                        this.getAllCheckedByOfficerWithPagination();
            ...
            addVisaSubmit(){
                this.form4.post('/api/add-visa-submit')
                    .then((response) => {
                        this.form4.reset()
                        this.getAllCheckedByOfficerWithPagination();
                        this.getAllSubmitedWithPagination();
            ...
            addVisaCollected(){
                this.form5.post('/api/add-visa-collected')
                    .then((response) => {
                        this.form5.reset()
                        this.getAllSubmitedWithPagination();
                        this.getAllCollectedWithPagination();
            ...
            addVisaCallAndSms(){
                this.form6.post('/api/add-visa-guest-call-and-sms')
                    .then((response) => {
                        this.form6.reset()
                        this.getAllCollectedWithPagination();
                        this.getAllGCSWithPagination();
            ...
            addVisaDelevered(){
                this.form7.post('/api/add-visa-delevered')
                    .then((response) => {
                        this.form7.reset()
                        this.getAllGCSWithPagination();
                        this.getAllDelevetedWithPagination();
