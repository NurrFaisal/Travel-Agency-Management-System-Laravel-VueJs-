                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Create new Visa Agency</h5>
                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main">


                                            <form @submit.prevent="addVisaAgency()" class="form-horizontal" method="post" role="form">
                                                <br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="submit" name="" class="button" style="background-color: #d3d3d380 !important;" value="Create New Visa Agency">
                                                    </div>
                                                </div>
    ...
    export default {
        ...
        methods: {
            addVisaAgency() {
                ...
                this.form.post('/api/add-visa-agency')
                    .then((response) => {
                        this.form.name = ''
                        ...
                        Toast.fire({
                            type: 'success',
                            title: ' New Visa Agency Added successfully'
                        })
                    })
            }
        }
