                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Salary</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateSalary()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            updateSalary(){
                this.form.post('/api/update-salary')
                    .then((response) => {
                        this.form.id = ''
            ...
            getSalary(){
                axios.get(`/api/edit-salary/${this.$route.params.id}`)
                    .then(response => {
                        this.form.fill(response.data.salary)
                    })
            },
            doAjax() {
                setTimeout(() => {
