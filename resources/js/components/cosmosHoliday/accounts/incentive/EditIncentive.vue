                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateIncentive()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            updateIncentive(){
                this.form.post('/api/update-incentive')
                    .then((response) => {
                        this.form.id = ''
            ...
            getIncentive(){
                axios.get(`/api/edit-incentive/${this.$route.params.id}`)
                    .then(response => {
                        this.form.fill(response.data.incentive)
                    })
            },
            doAjax() {
                setTimeout(() => {
