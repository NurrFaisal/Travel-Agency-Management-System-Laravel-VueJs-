                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Loan Installment Payment</h5>
                                        <div class="card-tools" style="float:right">
                                            <router-link to="/installment" class="btn btn-success">Loan Installment</router-link>
                                        </div>
                                        <br/>
                                    </div>
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addLoanInstallment()" class="form-horizontal" method="post" role="form">
...
<script>
    export default {
        ...
        methods:{
            ...
            addLoanInstallment(){
                this.form.post('/api/add-installment')
                    .then((response) => {
                        this.form.cash = ''
                        this.form.cheque = ''
                        ...
                        this.$router.push(`/installment/${this.form.loan_id}`)
                        Toast.fire({
                            type: 'success',
                            title: 'New Loan Installment Added successfully'
                        })
                    })
                    .catch((response) => {
