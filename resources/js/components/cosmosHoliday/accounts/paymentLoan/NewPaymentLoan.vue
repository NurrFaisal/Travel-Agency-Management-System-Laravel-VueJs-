                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Add Payment Loan</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addPaymentLoan()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            addPaymentLoan(){
                this.isLoading = true
                this.form.post('/api/add-payment-loan')
                    .then((response) => {
                        this.form.pl_date = ''
                        this.form.pl_name = ''
                        this.form.cash = ''
