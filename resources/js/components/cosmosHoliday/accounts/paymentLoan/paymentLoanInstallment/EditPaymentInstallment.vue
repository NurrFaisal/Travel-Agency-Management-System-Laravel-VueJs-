                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updatePaymentLoanInstallment()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditPaymentInstallment",
        mounted(){
            this.isLoading = true
            this.getLoanName();
            this.editPLinstallment();
        ...
        methods:{
            ...
            editPLinstallment(){
                axios.get(`/api/edit-payment-loan-installment/${this.$route.params.id}`)
                    .then(response => {
                        this.form.fill(response.data.installment)
                        this.doAjax()
                    })
            },
            updatePaymentLoanInstallment(){
                this.isLoading = true
                this.form.post('/api/update-payment-loan-installment')
                    .then((response) => {
                        this.form.id = ''
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'New PL Installment Updated successfully'
                        })
                    })
                    .catch((response) => {
                        this.isLoading = false
