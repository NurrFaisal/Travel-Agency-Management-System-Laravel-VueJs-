...
<script>
    export default {
        ...
        methods:{
            getBankBook(){
                axios.get(`/api/get-all-bank-book-details/${this.$route.params.id}?page=`+this.pagination.current_page)
                    .then(response => {
