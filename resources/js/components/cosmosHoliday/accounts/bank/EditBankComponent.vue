                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Bank</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="updateBank()" class="form-horizontal" method="post" role="form">
...
<script>
    export default {
        ...
        methods:{
            editBank(){
                axios.get(`/api/edit-bank/${this.$route.params.id}`)
                    .then((response) => {
                        this.form.fill(response.data.bank)
                    })
            },
            updateBank(){
                this.form.post('/api/update-bank')
                    .then((response) => {
                        this.form.id = ""
                        this.form.bank_name = ""
