                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Contra Voucher</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateContra()" class="form-horizontal" method="post" role="form">
...
<!--                                                            <input type="hidden" required v-model="form.id">-->
                                                        </div>
                                                ...
                                                <div v-if="form.contra_type == 1"  style="background-color: #f6f6f6; padding: 15px; margin: 20px;padding-bottom: 55px; cursor: pointer;">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="col-md-6">
                                                            <div class="col-xs-12 col-sm-12">
                                                                ...
                                                                <span class="block input-icon input-icon-right">
                                                                <input v-model="form.contra_date" required :class="{ 'is-invalid': form.errors.has('contra_date') }"   class="col-xs-12 col-sm-12" id="contra_date" name="contra_date" type="date">
                                                            </span>
                                                            </div>
                                                            <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-xs-12 col-sm-12">
                                                                ...
                                                                <span class="block input-icon input-icon-right">
                                                                <select v-model="form.bank_name" v-validate="'required'" :class="{ 'is-invalid': form.errors.has('bank_name') }" required  id="bank_name" name="bank_name" class="col-xs-12 col-sm-12" >
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="col-md-6">
                                                            <div class="col-xs-12 col-sm-12">
                                                                <label for="contra_amount">
                                                                    Amount<span class="text-danger">*</span> :
                                                                </label>
                                                                <span class="block input-icon input-icon-right">
                                                                <input  v-model="form.contra_amount"   :class="{ 'is-invalid': form.errors.has('contra_amount') }"   class="col-xs-12 col-sm-12" id="contra_amount" name="contra_amount" placeholder="Enter Contra Amount" required="" type="number">
                                                            </span>
                                                            </div>
                                                            <div class="col-xs-offset-2 col-xs-9 text-danger">
                                                                <has-error style="color:red" :form="form" field="contra_amount"></has-error>
                                                                <span style="color: red">{{ errors.first('contra_amount') }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="col-xs-12 col-sm-12">
                                                                ...
                                                                <span class="block input-icon input-icon-right">
                                                                <input  v-model="form.narration" required :class="{ 'is-invalid': form.errors.has('narration') }"   class="col-xs-12 col-sm-12" id="narration" name="narration" placeholder="Enter Some Narration" type="text">
                                                            </span>
                                                            </div>
                                                            <div class="col-xs-offset-2 col-xs-9 text-danger">
        ...
        methods:{
            ...
            editContra(){
                axios.get(`/api/edit-contra/${this.$route.params.id}`)
                    .then((respose) => {
                        this.form.fill(respose.data.contra)
                    })
            }
