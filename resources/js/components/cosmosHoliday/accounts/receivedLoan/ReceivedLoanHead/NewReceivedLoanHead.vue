                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">New Received Loan Head</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="addReceivedLoanHead()" class="form-horizontal" method="post" role="form">
...
<script>
    export default {
        ...
        methods:{
            addReceivedLoanHead(){
                this.form.post('/api/add-received-loan-head')
                    .then((response) => {
                        this.form.name = ""
                        this.$router.push('/received-loan-head-list')
                        Toast.fire({
                            type: 'success',
                            title: 'Received Loan Head Added successfully'
                        })
