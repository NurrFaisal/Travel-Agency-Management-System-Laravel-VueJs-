                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateRLInstallment()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        name: "EditReceivedLoanInstallment",
        components: {Loading},
        mounted(){
            this.isLoading = true
            this.getLoanName();
            this.getInstallmentsById();
        ...
        methods:{
            ...
            updateRLInstallment(){
                this.isLoading = true
                this.form.post('/api/update-received-loan-installment')
                    .then((response) => {
                        this.form.rl_id = ''
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'New RL Installment Added successfully'
                        })
                    })
                    .catch((response) => {
                        this.isLoading = false
            ...
            getInstallmentsById(){
                axios.get(`/api/edit-rl-installment/${this.$route.params.id}`)
                    .then((respose) => {
