                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Update Expence Head</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="updateExpenceHead()" class="form-horizontal" method="post" role="form">
...
<script>
    export default {
        ...
        mounted(){
            axios.get(`/api/edit-expence-head/${this.$route.params.id}`)
                .then((response) => {
                    this.form.fill(response.data.expence_head)
                })
        },
        methods:{
            updateExpenceHead(){
                this.form.post('/api/update-expence-head')
                    .then((response) => {
                        this.form.name = ''
                        this.form.id = ''
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Expence Head Updated successfully'
                        })
                    })
            }
        }
