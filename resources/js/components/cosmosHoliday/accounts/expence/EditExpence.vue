                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Expence</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateExpence()" class="form-horizontal" method="post" role="form">
...
<script>
    export default {
        ...
        methods:{
            ...
            updateExpence(){
                this.form.post('/api/update-expence')
                    .then((response) => {
                        this.form.id = ''
            ...
            getExpence(){
                axios.get(`/api/edit-expence/${this.$route.params.id}`)
                    .then(response => {
