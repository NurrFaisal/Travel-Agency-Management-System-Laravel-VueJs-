        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <router-link to="/new-hotel-booking">New Hotel Booking</router-link>
                    </li>
                </ul><!-- /.breadcrumb -->
                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Create Hotel Booking</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addHotelBooking()" class="form-horizontal" method="post" role="form">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            addHotelBooking(){
                this.isLoading = true
                this.form.post('/api/add-hotel-booking')
                    .then((response) => {
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'New Hotel Booking Added successfully'
                        })
                    })
                    .catch((response) => {
                        this.isLoading = false
