                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="updateStaffInformation()" class="form-horizontal" method="post" role="form">
                                                ...
                                                <div class="form-group ">
                                                    <div class="col-md-6">
                                                        <div class="col-xs-12 col-sm-12">
                                                            ...
                                                            <span class="block input-icon input-icon-right">
                                                                <input style="background-color: white!important;" name="photo"   v-validate="'image'" data-vv-as="image" @change = "changePhoto($event)" type="file" id="photo">
                                                            </span>
                                                            <br/>
                                                            <span class="block input-icon input-icon-right">
