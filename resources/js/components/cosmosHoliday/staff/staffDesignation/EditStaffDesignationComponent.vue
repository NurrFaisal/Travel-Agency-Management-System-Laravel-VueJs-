                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Edit Staff Designation</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin:0 auto;">
                                            <form @submit.prevent="updateStaffDesignation()" class="form-horizontal" method="post" role="form">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-7">
                                                        ...
                                                        <input v-validate="'required'" v-model="form.id" :class="{ 'is-invalid': form.errors.has('id') }"   class="col-xs-12 col-sm-8" id="id" name="staff_designation" type="hidden">
...
<script>
    export default {
        name: "EditStaffDesignationComponent",
        mounted(){
            axios.get(`/api/edit-staff-designation/${this.$route.params.id}`)
                .then((response) => {
                this.form.fill(response.data.staff_designation)
            })
        },
        data(){
            return{
        ...
        methods:{
            updateStaffDesignation(){
                this.form.post('/api/update-staff-designation')
                    .then((response) => {
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Staff Designation Updated successfully'
                        })
