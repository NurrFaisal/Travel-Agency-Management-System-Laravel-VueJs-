        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <router-link to="/new-visa">New Air Ticket</router-link>
                    </li>
                </ul><!-- /.breadcrumb -->
            </div>
                            ...
                            <div class="">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Create New Air-Ticket</h5>
                                    ...
                                    <div class="widget-body justify-content-center">
                                        <div class="widget-main justify-content-center" style="margin: 0px 100px;">
                                            <form @submit.prevent="addAirTicket()" class="form-horizontal" method="post" role="form">
    ...
    export default {
        ...
        methods:{
            ...
            addAirTicket(){
                ...
                this.form.post('/api/add-air-ticket')
                    .then((response) => {
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'New Air Ticket Added successfully'
                        })
                    })
                    .catch((response) => {
                        this.isLoading = false
            ...
            changeTotalAmount(){
                ...
                this.form.total_amount += parseInt(this.form.adult_total_price+this.form.child_total_price+this.form.infant_total_price+this.form.ssr_total_price+this.form.service_amount);
