...
class InstallmentController extends Controller
{
    ...
    public function editInstallment($id){
        $installment = Installment::where('id', $id)->with(['cashs' => function($q){$q->select('id', 'installment_id', 'cash_date', 'credit_cash_amount');}, 'cheques' => function($q){$q->select('id', 'installment_id', 'bank_name','bank_date', 'bank_cheque_number', 'credit_bank_amount');}])->first();
        return response()->json([
